...
<body>        
    ...
    <div class="rounded border border-dark p-4 m-5" style="padding: 10px; text-align: center">
     ...
     <form method="POST" action="PacienteController?action=update"> 
        ...
        <select style="width:300px; display: block; margin-right: auto; margin-left: auto; text-align: center" class="form-select" id="idtipoplano" name="idtipoplano" required>
            <option hidden value="<%= paciente.getIdTipoPlano() %>"><%= tipoplanoDAO.get(paciente.getIdTipoPlano()).getDescricao() %></option>
            <%
