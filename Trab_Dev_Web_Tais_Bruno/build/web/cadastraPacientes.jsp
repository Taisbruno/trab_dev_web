...
<html lang="pt-BR">
    <head>
        ...
        <title> Clínica Tais Bruno - Cadastra Pacientes </title>
    </head>
    <body>
        ...
        <div class="card-title">
                <div class="card-body" style="padding: 10%; text-align: center;">
                    <h2 class="card-title" style="margin-top: 10px; padding-bottom: 2%; text-align: center">Cadastra Pacientes</h2>
        ...
        <div class="container">
            ...
            <div class="container">
                <a class="navbar-brand" href="#"><b>Pacientes</b></a>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-borderless table-hover table-sm">
                    <caption>Lista de Pacientes - Total: <%= pacientes.size() %></caption>
                    ...
                    <tbody>
                        <%
                            for (int index = 0; index < pacientes.size(); index++) {
                                ...
                                String linkVisualizar = "VisualizarPacienteController?action=get&id=" + paciente.getId();
                        %>
                            <tr>
                                <td><%= paciente.getNome() %></td>
                                <td><%= paciente.getCpf() %></td>
                                <td><%= paciente.getSenha() %></td>
                                <td><%= paciente.getAutorizado() %></td>
                                <td><%= tipoplanoDAO.get((pacienteDAO.get(paciente.getId()).getIdTipoPlano())).getDescricao() %></td>
