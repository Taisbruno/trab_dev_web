...
<body>        
    ...
    <h3 class="card-title" style="margin-top: 60px">Login - Paciente</h3>
    <form method="POST" action="LoginController?action=loginpaciente" style="text-align: center; margin-top: 30px">                   
